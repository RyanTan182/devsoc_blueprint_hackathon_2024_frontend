...
export default function WelcomePage() {
    ...
    let animatedWords = ['Gaming  Chair ?', 'Piano  Lessons ?', 'Voice Actor ?', 'Screen Writer ?', '']
    ...
    let sellers = [{ 'name': 'Einstein', 'role': 'Physicist', 'description': 'Hi! I will solve all your Physics related doubts!' },
    ...
    const keepScrolling = (jump, duration) => {
        ...
        //     scrollToPosition(jump, duration);
        // }, 3000); 
